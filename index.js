//Base 100% Editable creditos a GiyuTomiokaBot-MD 
...
✦━─┈༓༒༓┈─━✦
`
  await sock.sendMessage(anu.id,{image : { url : "https://i.postimg.cc/CxCb7HjH/9d10aafef18b9f6c83ad841de1bee9cb.jpg" }, caption : teks})
    }
...
case 'owner':
case 'serowner':
enviar(`*Ya tengo dueño*`);
break

case 'canal':
case 'canales':
enviar(`No hay canales disponibles`)
break
...
if(boij2){
enviar(`Creando tu sticker espere un poco ❤️`)
var pack = `
👑 Dueño del Bot 👑
 ✅Un Venezolano
⭐𝐂𝐫𝐞𝐚𝐝𝐨 𝐩𝐨𝐫 :
...
if (isGroup && isAntiLink && !isGroupAdmins && !isOwner) {
  if (texto.includes("https://chat.whatsapp.com") || texto.includes("pornhub.com") || texto.includes("xvideos.com") || texto.includes("xnxx.com") || texto.includes("hentaihaven.red") || texto.includes("redtube.com") || texto.includes("hentaihaven.red") || texto.includes("brazzers.com") || texto.includes("onlyfans.com") || texto.includes("https://t.me")) {
    ...
    try {
      ...
      await enviar(`🚫 JAJAJAJA te vas por puto`, { mentions: [sender] })
